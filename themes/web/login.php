    ...
    <div class="main-login">
        ...
        <div class="right-login">
            <div class="card-login">
                ...
                <h4><a class="alteracao" href="alteration.php">deseja alterar seus dados? clique aqui!</a></h4>
                <br>
            <h4><a class="alteracao" href="register.php">Cadastre-se</a></h4>
                <div id="message">

                </div>
                <a class="back" href="_theme.php">Voltar</a>
            </div>
        </div>
    </div>
</form>
