    ...
    <section class="container produtos">
      ...
      <article class="row">
        ...
        <a href="#" class="produtos-container col-md-3">
          <!-- imagem do produto -->
          <img src="./assets/web/images/volantegm.webp" class="img-fluid" alt="Volante gm">
        ...
        <a href="./" class="produtos-container col-md-3">
          <!-- imagem do produto -->
          <img src="./assets/web/images/pneu.jpg" class="img-fluid" alt="">

          <!-- itens do produto -->
          <article class="produtos-itens">
            <!-- title produto -->
            <h2>Pneu michelin 205/55 r16
            </h2>
            <!-- preco -->
            <strong class="produtos-preco">
              R$ 799,90
        ...
        <a href="#" class="produtos-container col-md-3">
          <!-- imagem do produto -->
          <img src="./assets/web/images/volante pulse.jpg" class="img-fluid" alt="Volante pulse">
        ...
        <a href="#" class="produtos-container col-md-3">
          <!-- imagem do produto -->
          <img src="./assets/web/images/Odorizante Little Trees Vanilla Pride.jpg" class="img-fluid" alt="Saia plisada">

          <!-- itens do produto -->
          <article class="produtos-itens">
            <!-- title produto -->
            <h2>Odorizante Little Trees Vanilla Pride</h2>
